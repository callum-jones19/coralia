...
pub fn emit_song_end(new_queue: VecDeque<Song>, new_previous: Vec<Song>) {
    info!("Player Events: song ended.");
}

pub fn emit_player_play(current_playback_pos: Duration, media_controls: &mut MediaControls) {
...
pub fn emit_player_pause(current_playback_pos: Duration, media_controls: &mut MediaControls) {
    info!("Player Events: sink playback started.");
