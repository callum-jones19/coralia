export default function SongListHeader() {
  return (
    <div className="font-bold flex flex-row justify-between text-start gap-4 border-b-2 bg-neutral-200 dark:bg-neutral-700 border-neutral-300 dark:border-neutral-600 border-solid h-full items-center text-nowrap">
